    ...
    return (
        <div className="flex flex-col">
            <div className='flex flex-row justify-between items-center w-full h-16 mt-8 mb-4'>
                <div>
                    <h1 className="text-3xl font-bold text-black ml-16">
                Monitoring dashboard
            </h1>
            <p className='ml-16'>{br_web} web sites monitored at the moment</p>
                </div>
                <div>
            ...
            <div className='relative px-16 mt-8 mb-4'>
                <input className='border-2 border-gray-800 rounded-2xl p-3 min-w-100' placeholder='Search...' type="text" />
            </div>
            <div className="w-full h-full px-16 mt-4  grid grid-cols-4 gap-8">
